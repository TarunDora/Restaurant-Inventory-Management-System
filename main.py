    ...
    def get_all_sales_ui():
        ...
        try:
            ...
            if sales:
                ...
                messagebox.showwarning("No Data", "No sales found.")
...
def manager():
        ...
        try:
            ...
            if ingredients:
                for ingredient in ingredients:
                    ingredients_table.insert("", tk.END, values=(ingredient['name'],ingredient['quantity'],ingredient['unit'],ingredient['cpu'],ingredient['rl'],ingredient['edate'],ingredient['sid'],ingredient['status']))
            else:
    ...
    def get_ingredient_ui():
        ...
        try:
            ...
            #print(ingredients)
            if ingredients:
                    ingredients_table.insert("", tk.END, values=(ingredients['name'],ingredients['quantity'],ingredients['unit'],ingredients['cpu'],ingredients['rl'],ingredients['edate'],ingredients['sid'],ingredients['status']))
            else:
                messagebox.showwarning("No Data", "No ingredients found.")
    ...
    low_ingredients_button.grid(row=4, column=0, columnspan=2, pady=5)
    # Treeview for displaying dishes
    i_columns = ('name','quantity','unit','cpu','rl','edate','sid','status')
    ...
    for col in i_columns:
        ...
        ingredients_table.column(col, width=120)
